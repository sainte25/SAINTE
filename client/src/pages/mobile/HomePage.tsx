...
export default function HomePage() {
  ...
  // Get care team
  const { data: careTeam, isLoading: careTeamLoading } = useQuery<
    CareTeamMember[]
  >({
              ...
              <div className="mt-3">
                ...
                <div className="mt-3 text-sm bg-white/20 p-2 rounded-lg">
                  {userData?.tier === "Bronze" &&
                    "You're making good progress. Keep up your daily steps!"}
                  {userData?.tier === "Silver" &&
                    "You're consistently building social capital!"}
                  {userData?.tier === "Gold" &&
                    "Outstanding progress! You're a community leader."}
                  {!userData?.tier &&
                    "Complete daily steps to increase your score!"}
                </div>
                <div className="mt-3">
                  <Button variant="secondary" className="w-full" asChild>
                    <Link href="/mobile/goals">Set Today's Goals</Link>
                  </Button>
                </div>
              </div>
            </CardContent>
          ...
          <CardContent className="pt-4">
            ...
            <div className="mt-3">
              <Button variant="outline" className="w-full" asChild>
                <Link href="/mobile/mood">Log Today's Mood</Link>
              </Button>
            </div>
          </CardContent>
        </Card>
            ...
            <div className="mt-3 space-y-2">
              ...
              <div className="bg-gradient-to-r from-amber-50/30 to-amber-100/30 rounded-lg p-3 border border-amber-100">
                <div className="flex items-center">
                  ...
                  <div className="ml-3">
                    ...
                    <div className="text-xs flex items-center">
                      <Star
                        className="w-3 h-3 text-amber-600/70 mr-1"
                        fill="currentColor"
                      />
                      <span className="text-gray-600">
                        Bronze Tier • 83 SCCS
              ...
              <div className="text-center mt-3">
                <Button variant="outline" size="sm" className="text-xs" asChild>
                  <Link href="/mobile/profile">View Complete Leaderboard</Link>
                </Button>
              </div>
            </div>
          </CardContent>
        ...
        {!insightLoading && aiInsight && (
          <Card>
            <CardContent className="pt-4">
              ...
              <div className="mt-3">
                <Button variant="outline" className="w-full" asChild>
                  <Link href="/mobile/chat">Discuss with AI Companion</Link>
                </Button>
              </div>
            </CardContent>
          </Card>
              ...
              <div className="flex justify-center">
                <div className="relative w-48 h-48">
                  ...
                  {careTeam.slice(0, 5).map((member, index) => {
                    ...
                    const angle =
                      index *
                      (360 / Math.min(careTeam.length, 5)) *
                      (Math.PI / 180);
                    ...
                    if (member.role === "case_manager")
                      bgColor = "bg-purple-500";
                    if (member.role === "primary_care_provider")
                      bgColor = "bg-red-500";
                    if (member.role === "community_health_worker")
                    ...
                    return (
                      ...
                      >
                        <div
                          className={`w-full h-full rounded-full ${bgColor} flex items-center justify-center text-white shadow-md`}
                        >
                        ...
                        <div className="absolute top-full left-1/2 transform -translate-x-1/2 mt-1 whitespace-nowrap">
                          ...
                          <div className="text-[10px] text-gray-500">
                            {member.role === "peer_mentor"
                              ? "Peer Mentor"
                              : member.role === "case_manager"
                                ? "Case Manager"
                                : member.role === "primary_care_provider"
                                  ? "PCP"
                                  : member.role === "community_health_worker"
                                    ? "CHW"
                                    : member.role}
                          </div>
                        </div>
